...
package com.realme.realmeparts.kcal;
...
public interface Utils {
    ...
    String KCAL_ENABLE = "/sys/module/msm_drm/parameters/kcal_enable";
    String KCAL_CONT = "/sys/module/msm_drm/parameters/kcal_cont";
    String KCAL_HUE = "/sys/module/msm_drm/parameters/kcal_hue";
    String KCAL_MIN = "/sys/module/msm_drm/parameters/kcal_min";
    String KCAL_RGB = "/sys/module/msm_drm/parameters/kcal";
